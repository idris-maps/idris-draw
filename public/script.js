	...
	var btn = L.Control.extend({
		...
		onAdd: function(map) {
		 ...
		 container.style.height = '30px'
			...
			container.innerHTML = '<img id="download-btn" src="data:image/png;base64,' 
...
},{"./save":5}],3:[function(require,module,exports){
...
},{"./Data":1,"./download-button":2,"./on-event":4}],4:[function(require,module,exports){
